...
public class BranchAndPricingController {
	...
	public List<BranchEntity> getAll() {
	 ...
	 @PutMapping("/update/{priceId}")
	    public ResponseEntity<PricingEntity> updatePrice(@PathVariable Integer priceId, @RequestBody PricingEntity price) {
	 ...
	 @DeleteMapping("/delete/{branchId}")
		public String deleteById(@PathVariable Integer branchId) {
	    ...
	    public ResponseEntity<PricingEntity> getPriceById(@PathVariable Integer priceId) {
	...
	public List<PricingEntity> getAllPricing() {
	 ...
	 @DeleteMapping("/delete/{priceid}")
		public String deletePricing(@PathVariable Integer priceId) {
