...
import com.tejaswi.exception.IdNotFoundExcepction;
import com.tejaswi.entity.FileCreationEntity;
import com.tejaswi.entity.PropertyDetailsEntity;
import com.tejaswi.repo.FileCreationRepository;
...
public class FileCreationServiceImpl implements FileCreationService 
{
	...
	public FileCreationEntity saveFile(String entity, String branch, String clientName, String mobile, String address,
        ...
        fileCreationEntity.setEntity(entity);
	...
	public FileCreationEntity updateFile(Integer fileId, String entity, String branch, String clientName, String mobile,
			String address, List<PropertyDetailsEntity> properties, MultipartFile documents, String documentName,
			String verifiedStatus) {
	...
	public FileCreationEntity getFileById(Integer fileId) {
		return fileCreationRepository.findById(fileId).orElseThrow(()->new IdNotFoundExcepction("user not found with this id" +fileId));
	}
